...
public class ProdactExcel {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<Product> listproduits;
    public ProdactExcel(List<Product> listproduits) {
    ...
    private void writeDataLines() {
        ...
        for (Product art  :listproduits) {
            ...
            createCell(row, columnCount++, art.getCategory(), style);
            ...
            createCell(row, columnCount++, String.valueOf(art.getFour()), style);
